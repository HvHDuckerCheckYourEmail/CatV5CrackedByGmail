...
runcode(function()
	...
	ClientSidedDisabler = GuiLibrary["ObjectsThatCanBeSaved"]["BlatantWindow"]["Api"].CreateOptionsButton({
...
runcode(function()
	...
	oofspam = GuiLibrary["ObjectsThatCanBeSaved"]["BlatantWindow"]["Api"].CreateOptionsButton({
		["Name"] = "Oofspam",
		["Function"] = function(callback)
			if callback then
...
runcode(function()
	...
	RecordingMode = GuiLibrary["ObjectsThatCanBeSaved"]["BlatantWindow"]["Api"].CreateOptionsButton({
		["Name"] = "RecordingMode",
		["Function"] = function(callback)
			if callback then
...
runcode(function()
	...
	Night = GuiLibrary["ObjectsThatCanBeSaved"]["BlatantWindow"]["Api"].CreateOptionsButton({
		["Name"] = "Night",
		["Function"] = function(callback)
			if callback then
...
runcode(function()
	...
	slowautowin = GuiLibrary["ObjectsThatCanBeSaved"]["BlatantWindow"]["Api"].CreateOptionsButton({
		["Name"] = "SlowAutowin",
		["Function"] = function(callback)
			if callback then
...
runcode(function()
	...
	chatdisabler = GuiLibrary["ObjectsThatCanBeSaved"]["BlatantWindow"]["Api"].CreateOptionsButton({
		["Name"] = "ChatDisabler",
...
runcode(function()
	...
	local FemboyMode = GuiLibrary["ObjectsThatCanBeSaved"]["BlatantWindow"]["Api"].CreateOptionsButton({
		["Name"] = "FemboyMode",
...
runcode(function()
	...
	local remote = bedwars["ClientHandler"]:Get(bedwars["PickupRemote"])
		...
		diedumbass = GuiLibrary["ObjectsThatCanBeSaved"]["BlatantWindow"]["Api"].CreateOptionsButton({
			["Name"] = "GameRuiner",
			["Function"] = function(callback)
				if callback then
					game:GetService("NetworkClient"):SetOutgoingKBPSLimit(math.huge)
...
diedumbass2 = GuiLibrary["ObjectsThatCanBeSaved"]["BlatantWindow"]["Api"].CreateOptionsButton({
	["Name"] = "FlagAll",
	["Function"] = function(callback)
		if callback then
			game:GetService("NetworkClient"):SetOutgoingKBPSLimit(math.huge)
...
anticheatdisabler = GuiLibrary["ObjectsThatCanBeSaved"]["BlatantWindow"]["Api"].CreateOptionsButton({
	["Name"] = "FloatDisabler",
	["Function"] = function(callback)
		if callback then
